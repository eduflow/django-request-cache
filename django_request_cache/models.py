...
https://github.com/beachmachine/django-userforeignkey/blob/master/django_userforeignkey/models/fields.py
"""
import logging
...
class UserForeignKey(ForeignKey):
    ...
    def pre_save(self, model_instance, add):
        ...
        if current_user.pk and (
            self.auto_user or (self.auto_user_add and add and not object_user)
        ):
