# -*- coding: utf-8 -*-
"""
Vendorized from @beachmachine/django-userforeignkey, BSD Licensed
https://github.com/beachmachine/django-userforeignkey/blob/master/django_userforeignkey/request.py
"""
import logging
...
def set_current_request(request):
    ...
    return setattr(_thread_locals, "__django_request_cache__current_request", request)
...
def get_current_request():
    ...
    """
    return getattr(_thread_locals, "__django_request_cache__current_request", None)
